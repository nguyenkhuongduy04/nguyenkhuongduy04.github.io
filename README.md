...
<html b:css='false' b:defaultwidgetversion='2' b:js='false' b:layoutsVersion='3' b:templateUrl='indie.xml' b:templateVersion='1.3.0' class='v2' expr:dir='data:blog.languageDirection' lang='vi' xmlns='http://www.w3.org/1999/xhtml' xmlns:b='http://www.google.com/2005/gml/b' xmlns:data='http://www.google.com/2005/gml/data' xmlns:expr='http://www.google.com/2005/gml/expr'>
    &lt;head&gt;
        ...
        <link href='ảnh nhỏ hiển thị' rel='shortcut icon' type='image/x-icon'/>
        <meta content='https://i.imgur.com/eFQCkhY.jpg' property='og:image'/>
        <meta content='web của ae' property='og:url'/>
        <meta content='website' property='og:type'/>
        <meta content='Nguyễn Khương Duy' property='og:title'/>
        <meta content='Xây dựng và phát triển bởi tên ae !' property='og:description'/>
        ...
        /* Chèn CSS vào đây */
            ...
            /* Admin: Nguyễn Khương Duy                */
            /* Phone: 0328756191             */
            /* Gmail:  npndz.user.vn@gmail.com*/
            /* Website: viaclonegiare.tk */
            /*----------------------------------*/
    ...
    &lt;body&gt;
        ...
        <div class='wrapper'>
            <div class='profile-card js-profile-card'>
                <div class='profile-card__img'>
                    <img alt='profile card' src='ảnh to của ae'/>
                </div>
                <div class='profile-card__cnt js-profile-cnt'>
                    <div class='profile-card__name'>tên ae <i class='fa fa-check-circle' style='color:rgb(17, 143, 249)' title='Verified Author'/>
                    </div>
                    <div class='profile-card__txt'>Tôi là <b>tên ae</b>,  chuyên ngành <b>Facebook</b> với ước mơ trở thành một hacked chuyên nghiệp. Tôi thích khám phá, tìm tòi và học hỏi những điều thú vị trên mạng Internet. Biết đôi chút về <i> Nền tảng xã hội facebook </i> ...</div>
                    <div class='profile-card-loc'>
                        <span class='profile-card-loc__icon'>
                            <svg class='icon'><use xlink:href='#icon-location'/></svg>
                        </span>
                        <span class='profile-card-loc__txt'>Vinh,Thanh Chương,Nghệ An </span>
                    </div>
                    <div class='profile-card-inf'>
                        <div class='profile-card-inf__item'>
                            <div class='profile-card-inf__title' id='count-followers'>10000</div>
                            <div class='profile-card-inf__txt'>Followers</div>
                        </div>
                        <div class='profile-card-inf__item'>
                            <div class='profile-card-inf__title' id='count-following'>10000</div>
                            <div class='profile-card-inf__txt'>Following</div>
                        </div>
                        <div class='profile-card-inf__item'>
                            <div class='profile-card-inf__title' id='count-posts'>10000</div>
                          <div class='profile-card-inf__txt'>Posts</div>
                        </div>
                        <div class='profile-card-inf__item'>
                            <div class='profile-card-inf__title' id='count-works'>1000</div>
                            <div class='profile-card-inf__txt'>Works</div>
                        </div>
                    </div>
                    <div class='profile-card-social'>
                        <a class='profile-card-social__item Fanfage' href='lik facebook ae' target='_blank'>
                            <span class='icon-font'>
                                <svg class='icon'><use xlink:href='#icon-facebook'/></svg>
                            </span>
                        </a>
                        <a class='profile-card-social__item twitter' href='' target='_blank'>
                            <span class='icon-font'>
                        ...
                        <a class='profile-card-social__item tik tok' href='lik tik tok ae' target='_blank'>
                            <span class='icon-font'>
                                <svg class='icon'><use xlink:href='#icon-github'/></svg>
                            </span>
                        </a>
                        <a class='profile-card-social__item codepen' href='t' target='_blank'>
                            <span class='icon-font'>
                                <svg class='icon'><use xlink:href='#icon-codepen'/></svg>
                            </span>
                        </a>
                        <a class='profile-card-social__item link' href='web của ae' target='_blank'>
                            <span class='icon-font'>
                    ...
                    <div class='profile-card-ctr'>
                        ...
                        <button class='profile-card__button button--orange' onclick='window.open(&apos;https://m.facebook.com/namremix.vn&apos;)'>Follow</button>
                    </div>
                </div>
                <div class='profile-card-message js-message'>
                    <form class='profile-card-form'>
                        <div class='profile-card-form__container'>
                            <textarea placeholder='Cảm ơn bạn đã quan tâm. Hiện tại, tính năng này chưa khả dụng, vui lòng thử lại sau. Chúc bạn một ngày tốt lành !'/>
                        </div>
        ...
        <b:if cond='data:displayname == &quot;Displaynone&quot;'><b:section id='Nam Offical.Vn'/></b:if>
        <script type='text/javascript'>
            /* Thả tim */
            ! function(e, t, a) {
                function n() {
